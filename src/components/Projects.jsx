...
const projects = [
  ...
  {
    title: 'CampusConnect',
    description: 'A low-bandwidth web platform designed for university students in Pakistan, featuring a Resource Hub, Book Exchange with PIN-based handoff, and an Anonymous Academic Q&A Board. Built as a PWA for accessibility across low-end devices.',
    tags: ['React', 'Tailwind', 'Node.js', 'PostgreSQL'],
    status: 'In progress',
    statusColor: 'text-slate-400 border-slate-400',
    github: 'https://github.com/Umm-e-Fatima/CampusConnect.git',
    demo: null,
    number: '02',
  },
  {
