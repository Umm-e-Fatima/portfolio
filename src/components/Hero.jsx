...
function Hero(){
    ...
    return (
        <section id="hero" className="min-h-screen bg-[#0a0a0f] pt-20 px-6 flex items-center justify-center">
            <div className="max-w-4x1 text-center">
                {/* main heading */}
                <motion.h1
                    initial={{opacity:0,y:20}}
                    animate={{opacity:1,y:0}}
                    transition={{duration:0.8,delay:0.2}}
                    className="text-6x1 md:text-7x1 font-bold text-white mb-4"
                >Umm e Fatima</motion.h1> 
                {/* Typewriter Title */}
                <motion.h2
                    initial={{opacity:0}}
                    animate={{opacity:1}}
                    transition={{duration:0.8,delay:0.4}}
                    className="text-4x1 md:text-5x1 fot-bold text-yellow-400 mb-6 h-16"
                >
                    {displayText}
                ...
                <motion.p
                    ...
                    className="text-xl text-slate-300 mb-12 max-w-2x1 mx-auto"
                >
                    I build beautiful, intelligent interfaces where AI and design meet.Chat with my AI assistant to learn more about my work.
                </motion.p>
                {/* CTA buttons */}
                <motion.div
                    initial={{opacity:0,y:20}}
